create or replace function elbaza.p27470_tree_property(_value jsonb, _name_mod text) returns jsonb
    language plpgsql
as
$$
declare 
...
alter function elbaza.p27470_tree_property(jsonb, text) owner to site;
