create or replace function elbaza.p27471_tree_duplicate(_name_mod text, _name_tree text, _name_table text, _name_table_children text) returns void
    language plpgsql
as
$$
--=================================================================================================
...
alter function elbaza.p27471_tree_duplicate(text, text, text, text) owner to site;
