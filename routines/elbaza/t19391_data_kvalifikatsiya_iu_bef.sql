create or replace function elbaza.t19391_data_kvalifikatsiya_iu_bef() returns trigger
    language plpgsql
as
$$
begin
...
alter function elbaza.t19391_data_kvalifikatsiya_iu_bef() owner to developer;
