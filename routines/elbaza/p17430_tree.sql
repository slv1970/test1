create or replace function elbaza.p17430_tree(_value jsonb, _name_mod text) returns jsonb
    language plpgsql
as
$$
declare 
...
alter function elbaza.p17430_tree(jsonb, text) owner to developer;
