create or replace function elbaza.t18888_data_nalogooblozheniye_iu_bef() returns trigger
    language plpgsql
as
$$
begin
...
alter function elbaza.t18888_data_nalogooblozheniye_iu_bef() owner to developer;
