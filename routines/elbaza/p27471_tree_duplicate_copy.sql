create or replace function elbaza.p27471_tree_duplicate_copy(_idkart integer, _parent integer) returns integer
    language plpgsql
as
$$
--=================================================================================================
...
alter function elbaza.p27471_tree_duplicate_copy(integer, integer) owner to site;
