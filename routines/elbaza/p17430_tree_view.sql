create or replace function elbaza.p17430_tree_view(_parent integer, _name_find text, _idkart integer, _name_table text, _name_table_children text) returns jsonb
    language plpgsql
as
$$
declare
...
alter function elbaza.p17430_tree_view(integer, text, integer, text, text) owner to developer;
