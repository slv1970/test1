create or replace function elbaza.t19008_data_geopozitsiya_iu_bef() returns trigger
    language plpgsql
as
$$
begin
...
alter function elbaza.t19008_data_geopozitsiya_iu_bef() owner to developer;
