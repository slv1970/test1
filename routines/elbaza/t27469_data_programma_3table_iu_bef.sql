create or replace function elbaza.t27469_data_programma_3table_iu_bef() returns trigger
    language plpgsql
as
$$
begin
...
alter function elbaza.t27469_data_programma_3table_iu_bef() owner to site;
