create or replace function elbaza.t17429_data_vid_meropriyatiya_iu_bef() returns trigger
    language plpgsql
as
$$
begin
...
alter function elbaza.t17429_data_vid_meropriyatiya_iu_bef() owner to developer;
