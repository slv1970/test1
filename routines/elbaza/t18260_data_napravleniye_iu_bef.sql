create or replace function elbaza.t18260_data_napravleniye_iu_bef() returns trigger
    language plpgsql
as
$$
begin
...
alter function elbaza.t18260_data_napravleniye_iu_bef() owner to developer;
