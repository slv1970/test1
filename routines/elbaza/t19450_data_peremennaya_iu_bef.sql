create or replace function elbaza.t19450_data_peremennaya_iu_bef() returns trigger
    language plpgsql
as
$$
begin
...
alter function elbaza.t19450_data_peremennaya_iu_bef() owner to developer;
