create or replace function elbaza.p27471_tree_view_filter_folder2(_parent_id text, _name_find text, _id text) returns jsonb
    language plpgsql
as
$$
declare
...
alter function elbaza.p27471_tree_view_filter_folder2(text, text, text) owner to site;
